...
public class ZeebeComponent extends DefaultComponent implements ClientSupplier {
    ...
    /**
     * A new zeebe camel component is created with an existing client. The configuration/creation of
     * the client is not in the responsibility of this component.
     * <p>
     * <pre>
     *     ZeebeClient client = ....;
     ...
     * @param remaining the part between <code>zeebe:</code> and the (optional) parameters. Used to
     * identify the use case and what endpoint to create.
    ...
    protected ZeebeEndpoint createEndpoint(final EndpointConfiguration configuration)
        throws Exception {
